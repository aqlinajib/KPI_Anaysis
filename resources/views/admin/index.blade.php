...
<div class="containerinfo">
    <div class="stat-card">
        ...
        <div class="description">Jumlah Kerja Harian yang Dibuat</div>
    </div>
    @if(Auth::user()->role == 'admin')
    
    <div class="stat-card">
        <div class="number">{{ $totalSop1 }}</div>
        <div class="description">Pengajuan Dokumen Sop</div>
    </div>
    <div class="stat-card">
        <div class="number">{{ $totalSop }}</div>
        <div class="description">Sop Berhasil Terbit</div>
    </div>
    @endif
    <div class="stat-card">
        <div class="number">{{ $jumlahAbsen }}</div>
        <div class="description">Jumlah Kehadiran</div>
    </div>
</div>
